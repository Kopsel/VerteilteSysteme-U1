...
public class GameMaster {
            ...
            public void run() {
                try {
                    ...
                    while ((inputLine = in.readLine()) != null) {
                        ...
                        gameMaster.logPlayerSubmission(new PlayerSubmission(message[0], message[1], message[2] + "s", message[3], LocalDateTime.now().toString()));
                    }
    ...
    public record PlayerSubmission(String playerName, String diceValue, String latency, String sendTimestamp, String receiveTimestamp) {}
}
